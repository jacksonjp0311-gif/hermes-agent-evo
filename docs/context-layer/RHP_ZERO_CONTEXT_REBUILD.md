...
- ok: `True`
- latest operation: `RHP-018.13`
- latest evidence: `docs/context-layer/ops/RHP-018-13-final-evidence.json`
- subject commit: `ddb24363e2fac630e7527a2c9eab31e6df50db52`
- observed CI status: `red`
- prior blocking state: `CLEAN_TOP_PROGRESS_BODY_CANON_ALIGNED_SUBJECT_UNRESOLVED`
- state: `README_CANONICAL_RUNTIME_RUN_BLOCK_ALIGNED_SUBJECT_UNRESOLVED`
