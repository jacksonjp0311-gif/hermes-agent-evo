...
- ok: `True`
- latest operation: `RHP-018.9`
- latest evidence: `docs/context-layer/ops/RHP-018-9-final-evidence.json`
- subject commit: `ddb24363e2fac630e7527a2c9eab31e6df50db52`
- observed CI status: `red`
- prior blocking state: `UNCOMPRESSED_OPERATOR_CONSOLE_CANON_ALIGNED_SUBJECT_UNRESOLVED`
- state: `RHPLOOP_DOCTOR_SELF_LEARNING_CANON_ALIGNED_SUBJECT_UNRESOLVED`
