...
- ok: `True`
- latest operation: `RHP-018.12`
- latest evidence: `docs/context-layer/ops/RHP-018-12-final-evidence.json`
- subject commit: `ddb24363e2fac630e7527a2c9eab31e6df50db52`
- observed CI status: `red`
- prior blocking state: `RUNTIME_PROGRESS_CONSOLE_CANON_ALIGNED_SUBJECT_UNRESOLVED`
- state: `CLEAN_TOP_PROGRESS_BODY_CANON_ALIGNED_SUBJECT_UNRESOLVED`
