...
- schema: `RHP-ZERO-CONTEXT-REBUILD-v2.4`
- ok: `True`
- latest operation: `RHP-019.1`
- latest evidence: `docs/context-layer/ops/RHP-019-1-final-evidence.json`
- subject commit: `ddb24363e2fac630e7527a2c9eab31e6df50db52`
- observed CI status: `unknown`
- prior blocking state: `REPLACEMENT_CI_OBSERVATION_UNRESOLVED`
