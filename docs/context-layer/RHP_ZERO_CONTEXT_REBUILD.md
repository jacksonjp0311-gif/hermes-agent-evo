...
- ok: `True`
- latest operation: `RHP-018.8`
- latest evidence: `docs/context-layer/ops/RHP-018-8-final-evidence.json`
- subject commit: `ddb24363e2fac630e7527a2c9eab31e6df50db52`
- observed CI status: `red`
- prior blocking state: `VISIBLE_DEBUG_CANON_ALIGNED_PARTIAL_CI_EVIDENCE_SUBJECT_UNRESOLVED`
