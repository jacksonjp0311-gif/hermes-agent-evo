# RHP-013.5 startup context packet and RuntimeBootState.
...
def build_runtime_boot_state(
    ...
    *,
    ...
    protocol_strip = f"RHP RuntimeBootState: {status} | phase=pre-interaction | evidence=RHP-013.5 | authority=false"
    prompt_payload = {
    ...
    return RuntimeBootState(
        ...
        non_claim_lock=(
            "RHP-013.5 RuntimeBootState is the typed read-only boot truth packet wired into operator and banner surfaces. "
