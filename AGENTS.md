...
File counts shift constantly ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â don't treat the tree below as exhaustive.
The canonical source is the filesystem. The notes call out the load-bearing
entry points you'll actually edit.

```
hermes-agent/
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ run_agent.py          # AIAgent class ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â core conversation loop (~12k LOC)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ model_tools.py        # Tool orchestration, discover_builtin_tools(), handle_function_call()
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ toolsets.py           # Toolset definitions, _HERMES_CORE_TOOLS list
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ cli.py                # HermesCLI class ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â interactive CLI orchestrator (~11k LOC)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ hermes_state.py       # SessionDB ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â SQLite session store (FTS5 search)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ hermes_constants.py   # get_hermes_home(), display_hermes_home() ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â profile-aware paths
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ hermes_logging.py     # setup_logging() ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â agent.log / errors.log / gateway.log (profile-aware)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ batch_runner.py       # Parallel batch processing
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ agent/                # Agent internals (provider adapters, memory, caching, compression, etc.)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ hermes_cli/           # CLI subcommands, setup wizard, plugins loader, skin engine
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ tools/                # Tool implementations ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â auto-discovered via tools/registry.py
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ environments/     # Terminal backends (local, docker, ssh, modal, daytona, singularity)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ gateway/              # Messaging gateway ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â run.py + session.py + platforms/
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ platforms/        # Adapter per platform (telegram, discord, slack, whatsapp,
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡                     #   homeassistant, signal, matrix, mattermost, email, sms,
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡                     #   dingtalk, wecom, weixin, feishu, qqbot, bluebubbles,
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡                     #   yuanbao, webhook, api_server, ...). See ADDING_A_PLATFORM.md.
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ builtin_hooks/    # Extension point for always-registered gateway hooks (none shipped)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ plugins/              # Plugin system (see "Plugins" section below)
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ memory/           # Memory-provider plugins (honcho, mem0, supermemory, ...)
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ context_engine/   # Context-engine plugins
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ model-providers/  # Inference backend plugins (openrouter, anthropic, gmi, ...)
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ kanban/           # Multi-agent board dispatcher + worker plugin
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ hermes-achievements/  # Gamified achievement tracking
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ observability/    # Metrics / traces / logs plugin
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ image_gen/        # Image-generation providers
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ <others>/         # disk-cleanup, google_meet, platforms, spotify,
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡                         #   strike-freedom-cockpit, ...
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ optional-skills/      # Heavier/niche skills shipped but NOT active by default
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ skills/               # Built-in skills bundled with the repo
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ ui-tui/               # Ink (React) terminal UI ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `hermes --tui`
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡   ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ src/              # entry.tsx, app.tsx, gatewayClient.ts + app/components/hooks/lib
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ tui_gateway/          # Python JSON-RPC backend for the TUI
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ acp_adapter/          # ACP server (VS Code / Zed / JetBrains integration)
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ cron/                 # Scheduler ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â jobs.py, scheduler.py
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ scripts/              # run_tests.sh, release.py, auxiliary scripts
ÃƒÂ¢Ã¢â‚¬ÂÃ…â€œÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ website/              # Docusaurus docs site
ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ tests/                # Pytest suite (~17k tests across ~900 files as of May 2026)
```

**User config:** `~/.hermes/config.yaml` (settings), `~/.hermes/.env` (API keys only).
**Logs:** `~/.hermes/logs/` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `agent.log` (INFO+), `errors.log` (WARNING+),
...
```
tools/registry.py  (no deps ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â imported by all tool files)
       ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬Ëœ
...
minimum subset you'll usually touch ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â read `run_agent.py` for the full list.
...
class AIAgent:
    def __init__(self,
        ...
        model: str = "",                   # empty ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ resolved from config/provider later
    ...
    def chat(self, message: str) -> str:
        """Simple interface ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â returns final response string."""

    def run_conversation(self, user_message: str, system_message: str = None,
                         conversation_history: list = None, task_id: str = None) -> dict:
        """Full interface ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â returns dict with final_response + messages."""
```

### Agent Loop

The core loop is inside `run_conversation()` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â entirely synchronous, with
...
- **KawaiiSpinner** (`agent/display.py`) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â animated faces during API calls, `ÃƒÂ¢Ã¢â‚¬ÂÃ…Â ` activity feed for tool results
- `load_cli_config()` in cli.py merges hardcoded defaults + user config YAML
- **Skin engine** (`hermes_cli/skin_engine.py`) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â data-driven CLI theming; initialized from `display.skin` config key at startup; skins customize banner colors, spinner faces/verbs/wings, tool prefix, response box, branding text
- `process_command()` is a method on `HermesCLI` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â dispatches on canonical command name resolved via `resolve_command()` from the central registry
...
- **CLI** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `process_command()` resolves aliases via `resolve_command()`, dispatches on canonical name
- **Gateway** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `GATEWAY_KNOWN_COMMANDS` frozenset for hook emission, `resolve_command()` for dispatch
- **Gateway help** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `gateway_help_lines()` generates `/help` output
- **Telegram** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `telegram_bot_commands()` generates the BotCommand menu
- **Slack** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `slack_subcommand_map()` generates `/hermes` subcommand routing
- **Autocomplete** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `COMMANDS` flat dict feeds `SlashCommandCompleter`
- **CLI help** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `COMMANDS_BY_CATEGORY` dict feeds `show_help()`
...
**CommandDef fields:**
- `name` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â canonical name without slash (e.g. `"background"`)
- `description` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â human-readable description
- `category` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â one of `"Session"`, `"Configuration"`, `"Tools & Skills"`, `"Info"`, `"Exit"`
- `aliases` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tuple of alternative names (e.g. `("bg",)`)
- `args_hint` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â argument placeholder shown in help (e.g. `"<prompt>"`, `"[name]"`)
- `cli_only` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only available in the interactive CLI
- `gateway_only` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only available in messaging platforms
- `gateway_config_gate` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â config dotpath (e.g. `"display.tool_progress_command"`); when set on a `cli_only` command, the command becomes available in the gateway if the config value is truthy. `GATEWAY_KNOWN_COMMANDS` always includes config-gated commands so the gateway can dispatch them; help/menus only show them when the gate is open.

**Adding an alias** requires only adding it to the `aliases` tuple on the existing `CommandDef`. No other file changes needed ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â dispatch, help text, Telegram menu, Slack mapping, and autocomplete all update automatically.
...
```
hermes --tui
  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ Node (Ink)  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬stdio JSON-RPCÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬  Python (tui_gateway)
       ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡                                  ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ AIAgent + tools + sessions
       ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬ÂÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ renders transcript, composer, prompts, activity
```
...
|---------|---------------|----------------|
| Chat streaming | `app.tsx` + `messageLine.tsx` | `prompt.submit` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `message.delta/complete` |
| Tool activity | `thinking.tsx` | `tool.start/progress/complete` |
| Approvals | `prompts.tsx` | `approval.respond` ÃƒÂ¢Ã¢â‚¬Â Ã‚Â `approval.request` |
| Clarify/sudo/secret | `prompts.tsx`, `maskedPrompt.tsx` | `clarify/sudo/secret.respond` |
| Session picker | `sessionPicker.tsx` | `session.list/resume` |
| Slash commands | Local handler + fallthrough | `slash.exec` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `_SlashWorker`, `command.dispatch` |
...
2. Everything else ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `slash.exec` (runs in persistent `_SlashWorker` subprocess) ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `command.dispatch` fallback
...
### TUI in the Dashboard (`hermes dashboard` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `/chat`)

The dashboard embeds the real `hermes --tui` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â **not** a rewrite.  See `hermes_cli/pty_bridge.py` + the `@app.websocket("/api/pty")` endpoint in `hermes_cli/web_server.py`.

- Browser loads `web/src/pages/ChatPage.tsx`, which mounts xterm.js's `Terminal` with the WebGL renderer, `@xterm/addon-fit` for container-driven resize, and `@xterm/addon-unicode11` for modern wide-character widths.
- `/api/pty?token=ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦` upgrades to a WebSocket; auth uses the same ephemeral `_SESSION_TOKEN` as REST, via query param (browsers can't set `Authorization` on WS upgrade).
- The server spawns whatever `hermes --tui` would spawn, through `ptyprocess` (POSIX PTY ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â WSL works, native Windows does not).
- Frames: raw PTY bytes each direction; resize via `\x1b[RESIZE:<cols>;<rows>]` intercepted on the server and applied with `TIOCSWINSZ`.

**Do not re-implement the primary chat experience in React.** The main transcript, composer/input flow (including slash-command behavior), and PTY-backed terminal belong to the embedded `hermes --tui` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â anything new you add to Ink shows up in the dashboard automatically. If you find yourself rebuilding the transcript or composer for the dashboard, stop and extend Ink instead.

**Structured React UI around the TUI is allowed when it is not a second chat surface.** Sidebar widgets, inspectors, summaries, status panels, and similar supporting views (e.g. `ChatSidebar`, `ModelPickerDialog`, `ToolCall`) are fine when they complement the embedded TUI rather than replacing the transcript / composer / terminal. Keep their state independent of the PTY child's session and surface their failures non-destructively so the terminal pane keeps working unimpaired.

### Electron Desktop Chat App (`apps/desktop/`)

A **separate** chat surface from both the classic CLI and the dashboard's embedded TUI. It is an Electron + React + nanostore renderer (`@assistant-ui/react`) that talks to a `tui_gateway` backend over JSON-RPC (`requestGateway(method, params)`). It does NOT embed `hermes --tui` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â it has its own composer, transcript, and slash-command pipeline. Route desktop bugs to the `hermes-desktop-app-work` skill, not `hermes-dashboard-work`.
...
- **The renderer curates via `apps/desktop/src/lib/desktop-slash-commands.ts`.** This is the load-bearing file. It holds `DESKTOP_COMMANDS` (the ~19 built-ins shown in the palette) plus block-lists for terminal-only / messaging-only / picker-owned / settings-owned / advanced commands that should NOT clutter the desktop popover.
  - `isDesktopSlashCommand(name)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â gates **execution**. Returns true for built-ins AND for any non-built-in (skill / quick command), so typed extension commands run.
  - `isDesktopSlashSuggestion(name)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â gates **discovery/completion**. Used by BOTH completion paths in `app/chat/composer/hooks/use-slash-completions.ts` (empty-query catalog filter + typed-query `complete.slash` filter) and by `filterDesktopCommandsCatalog`.
  - `isDesktopSlashExtensionCommand(name)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â true when the command is NOT a known Hermes built-in (i.e. a skill or user quick command). Both suggestion and catalog-filter paths allow extensions through so skill commands surface in the palette. (Added when fixing "skill commands missing from the desktop slash palette" ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the curated allow-list was silently dropping every skill/quick command from completions even though they executed fine when typed.)
- **Dispatch** lives in `app/session/hooks/use-prompt-actions.ts` (`runSlash`): built-ins that the desktop owns (`/skin`, `/help`, `/new`, ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦) are handled locally or via `commands.catalog`; everything else goes to `slash.exec`, falling back to `command.dispatch` (which the gateway resolves into skill / alias / exec directives). A skill command resolves to `{type: "skill", message}` and is submitted as a normal prompt.

**Rule:** the desktop slash palette's curation is about hiding noise (terminal-only / messaging-only built-ins), NOT about hiding user-activated extensions. Skill commands and `quick_commands` are extensions the backend surfaces ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they belong in completions. If you tighten `desktop-slash-commands.ts`, keep `isDesktopSlashExtensionCommand` flowing into both the suggestion and catalog-filter paths. Tests: `apps/desktop/src/lib/desktop-slash-commands.test.ts` (run via the repo-root `vitest`, since `apps/desktop` resolves deps from the root workspace install).
...
**2. Add to `toolsets.py`** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â either `_HERMES_CORE_TOOLS` (all platforms) or a new toolset. **This step is required:** auto-discovery imports the tool and registers its schema, but the tool is only *exposed to an agent* if its name appears in a toolset. `_HERMES_CORE_TOOLS` is not dead code ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â it's the default bundle every platform's base toolset inherits from.

Auto-discovery: any `tools/*.py` file with a top-level `registry.register()` call is imported automatically ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no manual import list to maintain. Wiring into a toolset is still a deliberate, manual step.

The registry handles schema collection, dispatch, availability checking, and error wrapping. All handlers MUST return a JSON string.

**Path references in tool schemas**: If the schema description mentions file paths (e.g. default output directories), use `display_hermes_home()` to make them profile-aware. The schema is generated at import time, which is after `_apply_profile_override()` sets `HERMES_HOME`.

**State files**: If a tool stores persistent state (caches, logs, checkpoints), use `get_hermes_home()` for the base directory ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â never `Path.home() / ".hermes"`. This ensures each profile gets its own state.
...
3. Never commit a bare `>=X.Y.Z` without a ceiling ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â CI and reviewers will reject it.
...
embedding, title generation, session_search, etc.) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each task can pin
...
`curator` holds the background skill-maintenance config ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â
`enabled`, `interval_hours`, `min_idle_hours`, `stale_after_days`,
`archive_after_days`, `backup` (nested).

### .env variables (SECRETS ONLY ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â API keys, tokens, passwords):
...
the env var in code (see `gateway_timeout`, `terminal.cwd` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `TERMINAL_CWD`).

### Config loaders (three paths ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â know which one you're in):

| Loader | Used by | Location |
|--------|---------|----------|
| `load_cli_config()` | CLI mode | `cli.py` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â merges CLI-specific defaults + user YAML |
| `load_config()` | `hermes tools`, `hermes setup`, most CLI subcommands | `hermes_cli/config.py` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â merges `DEFAULT_CONFIG` + user YAML |
| Direct YAML load | Gateway runtime | `gateway/run.py` + `gateway/config.py` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â reads user YAML raw |

If you add a new key and the CLI sees it but the gateway doesn't (or vice
versa), you're on the wrong loader. Check `DEFAULT_CONFIG` coverage.

### Working directory:
- **CLI** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â uses the process's current directory (`os.getcwd()`).
- **Messaging** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â uses `terminal.cwd` from `config.yaml`. The gateway bridges this
  to the `TERMINAL_CWD` env var for child tools. **`MESSAGING_CWD` has been
  removed** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the config loader prints a deprecation warning if it's set in
...
The skin engine (`hermes_cli/skin_engine.py`) provides data-driven CLI visual customization. Skins are **pure data** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no code changes needed to add a new skin.
...
- `init_skin_from_config()` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â called at CLI startup, reads `display.skin` from config
- `get_active_skin()` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â returns cached `SkinConfig` for the current skin
- `set_active_skin(name)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â switches skin at runtime (used by `/skin` command)
- `load_skin(name)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â loads from user skins first, then built-ins, then falls back to default
...
| Per-tool emojis | `tool_emojis` | `display.py` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `get_tool_emoji()` |
...
- `default` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Classic Hermes gold/kawaii (the current look)
- `ares` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Crimson/bronze war-god theme with custom spinner wings
- `mono` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Clean grayscale monochrome
- `slate` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Cool blue developer-focused theme
...
branding:
  ...
  response_label: " ÃƒÂ¢Ã…Â¡Ã‚Â¡ Cyber "

tool_prefix: "ÃƒÂ¢Ã¢â‚¬â€œÃ‚Â"
```
...
- Register CLI subcommands via `ctx.register_cli_command(...)` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the
...
generic plugin surface (new hook, new ctx method) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â never hardcode
...
into `~/.hermes/plugins/` (or via pip entry points) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they implement
...
Every inference backend (openrouter, anthropic, gmi, deepseek, nvidia, ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦)
...
discovery system** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â scanned on first `get_provider_profile()` or
...
User plugins of the same name override bundled ones ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `register_provider()`
...
- **`skills/`** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â built-in skills shipped and loadable by default.
  Organized by category directories (e.g. `skills/github/`, `skills/mlops/`).
- **`optional-skills/`** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â heavier or niche skills shipped with the repo but
...
When reviewing skill PRs, check which directory they target ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â heavy-dep or
...
settings the skill needs ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â stored under `skills.config.<key>`, prompted
...
Every new or modernized skill ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â bundled, optional, or contributed ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â
must meet these standards before merge. Reviewers reject PRs that
violate them.

1. **`description` ÃƒÂ¢Ã¢â‚¬Â°Ã‚Â¤ 60 characters, one sentence, ends with a period.**
...
2. **Tools referenced in SKILL.md prose must be native Hermes tools or
   ...
   name shell utilities the agent already has wrapped ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `grep` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢
   `search_files`, `cat`/`head`/`tail` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `read_file`, `sed`/`awk` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢
   `patch`, `find`/`ls` ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ `search_files target='files'`. If the skill
...
3. **`platforms:` gating audited against actual script imports.**
   ...
   posture: try to fix it cross-platform first ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `tempfile.gettempdir`,
...
4. **`author` credits the human contributor first.** For external
   ...
   ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â credit the human, not the tool.
...
6. **Scripts go in `scripts/`, references in `references/`,
   ...
   parsers, XML walkers, or non-trivial logic every call ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ship a
...
8. **`.env.example` additions are isolated to a clearly delimited
   block.** Don't touch the surrounding file ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â contributor-supplied
   `.env.example` versions are usually stale and edits outside the
   skill's own block must be dropped during salvage.

The full salvage / modernization checklist for external skill PRs
lives in the `hermes-agent-dev` skill at
`references/new-skill-pr-salvage.md` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â load it before polishing
...
child's summary before continuing its own loop ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â if the parent is
interrupted, the child is cancelled.

Two shapes:

- **Single:** pass `goal` (+ optional `context`, `toolsets`).
- **Batch (parallel):** pass `tasks: [...]` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each gets its own subagent
  running concurrently. Concurrency is capped by
  `delegation.max_concurrent_children` (default 3).

Roles:

- `role="leaf"` (default) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â focused worker. Cannot call `delegate_task`,
  `clarify`, `memory`, `send_message`, `execute_code`.
- `role="orchestrator"` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â retains `delegate_task` so it can spawn its
...
- **Telemetry:** `tools/skill_usage.py` owns the sidecar
  `~/.hermes/skills/.usage.json` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â per-skill `use_count`, `view_count`,
  `patch_count`, `last_activity_at`, `state` (active / stale /
  archived), `pinned`.

Invariants:
- Curator only touches skills with `created_by: "agent"` provenance ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â
...
- **3-minute hard interrupt** on cron sessions ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â runaway agent loops
  cannot monopolize the scheduler.
- Catchup window: half the job's period, clamped to 120sÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“2h.
...
Cron deliveries are **not** mirrored into the target gateway session ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â
...
Isolation model:
- **Board** is the hard boundary ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â workers are spawned with
  `HERMES_KANBAN_BOARD` pinned in their env so they can't see other
  boards.
- **Tenant** is a soft namespace *within* a board ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â one specialist
...
- `all` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â running-output updates + final message (default)
- `result` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only the final completion message
- `error` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â only the final message when exit code != 0
- `off` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no watcher messages at all

---

## Profiles: Multi-Instance Support

Hermes supports **profiles** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â multiple fully isolated instances, each with its own
...
1. **Use `get_hermes_home()` for all HERMES_HOME paths.** Import from `hermes_constants`.
   ...
   # BAD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â breaks profiles
...
2. **Use `display_hermes_home()` for user-facing messages.** Import from `hermes_constants`.
   ...
   # BAD ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â shows wrong path for profiles
   print("Config saved to ~/.hermes/config.yaml")
   ```

3. **Module-level constants are fine** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they cache `get_hermes_home()` at import time,
   which is AFTER `_apply_profile_override()` sets the env var. Just use `get_hermes_home()`,
   not `Path.home() / ".hermes"`.

4. **Tests that mock `Path.home()` must also set `HERMES_HOME`** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â since code now uses
...
5. **Gateway platform adapters should use token locks** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â if the adapter connects with
   a unique credential (bot token, API key), call `acquire_scoped_lock()` from
   `gateway.status` in the `connect()`/`start()` method and `release_scoped_lock()` in
   `disconnect()`/`stop()`. This prevents two profiles from using the same credential.
   See `gateway/platforms/telegram.py` for the canonical pattern.

6. **Profile operations are HOME-anchored, not HERMES_HOME-anchored** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â `_get_profiles_root()`
   returns `Path.home() / ".hermes" / "profiles"`, NOT `get_hermes_home() / "profiles"`.
   This is intentional ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â it lets `hermes -p coder profile list` see all profiles regardless
...
for user-facing print/log messages. Hardcoding `~/.hermes` breaks profiles ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each profile
...
interactive menus must use `hermes_cli/curses_ui.py` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â see
...
Tool schema descriptions must not mention tools from other toolsets by name (e.g., `browser_navigate` saying "prefer web_search"). Those tools may be unavailable (missing API keys, disabled toolset), causing the model to hallucinate calls to non-existent tools. If a cross-reference is needed, add it dynamically in `get_tool_definitions()` in `model_tools.py` ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â see the `browser_navigate` / `execute_code` post-processing blocks for the pattern.

### The gateway has TWO message guards ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â both must bypass approval/control commands
...
with `git diff HEAD~1..HEAD` after merging ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â unexpected deletions are a
red flag.
...
**ALWAYS use `scripts/run_tests.sh`** ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â do not call `pytest` directly. The script enforces
...
ContextVars from one test cannot leak into the next ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the historic
...
- Per-test overhead is ~0.5ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“1.0s (Python startup + pytest collection). xdist
...
- Pass `--no-isolate` to disable isolation ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â useful when debugging a single
...
| xdist workers | `-n auto` = all cores | `-n auto` (safe ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â subprocess isolation prevents cross-worker flakes) |

`tests/conftest.py` also enforces points 1-4 as an autouse fixture so ANY pytest
invocation (including IDE integrations) gets hermetic behavior ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â but the wrapper
...
to change** gets updated ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â model catalogs, config version numbers,
...
```python
# catalog snapshot ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â breaks every model release
assert "gemini-2.5-pro" in _PROVIDER_MODELS["gemini"]
assert "MiniMax-M2.7" in models

# config version literal ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â breaks every schema bump
assert DEFAULT_CONFIG["_config_version"] == 21

# enumeration count ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â breaks every time a skill/provider is added
