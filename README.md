...
<!-- RHP_EXACT_RUNTIME_SCRIPT_TRACE_MAP_START -->
## RHP Exact Runtime Script Trace Map

This section preserves the exact executable trace for the active RHP operation. The loop is not preserved unless the exact executable trace is preserved.

```text
RHPSCRIPT-TRACE [GOLD] status=resolved
`- exact runtime script trace map
   +- operation: RHP-020.1
   +- all-one-script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1
   +- launch-location: $env:USERPROFILE\Downloads
   +- repo-root: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evo
   +- runtime-helper: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.py
   +- installed-module: rhp/runtime_script_trace_map.py
   +- focused-tests: tests/test_rhp_020_1_runtime_script_trace_map.py
   +- evidence-location: docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/
   +- final-evidence: docs/context-layer/ops/RHP-020-1-final-evidence.json
   +- stage-count: 19
   +- exact-script-bound: true
   `- authority: no grant [LOCKED]
```

### Complete stage-to-script map

### 1. ENTRYPOINT-GATE
```textstage: ENTRYPOINT-GATEexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1executing_language: PowerShellpython_script: nonerepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: $env:USERPROFILE\Downloadsworking_directory_after: $env:USERPROFILE\Downloadscommands:  - nonepurpose: Verify exact All-One filename and prevent pasted/dot-sourced execution.writes_repo: Falsewrites_remote: Falseraw_artifacts:  - $env:TEMP\RHP-020-1-python-streams\entrypoint-gate.txtrepo_evidence:  - nonenext_stage: ROOT-ANCHORforbidden:  - continue if filename mismatch or no file invocationgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 2. ROOT-ANCHOR
...
### 8. OPERATION-START
```textstage: OPERATION-STARTexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1executing_language: PowerShell launching generated Python helperpython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - rhp/runtime_script_trace_map.pylaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Start bounded helper operation and write the exact runtime script trace map.writes_repo: Truewrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/next_stage: RHPLOOP-DOCTORforbidden:  - scope creep beyond declared pathsgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 9. RHPLOOP-DOCTOR
```textstage: RHPLOOP-DOCTORexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Pythonpython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - rhp/rhpload_doctor.py  - rhp/doctor_cli.py  - rhp/loop_doctor.pylaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - python -m rhp.doctor_cli --repo-root . --current-head-ci-status unknown --ci-source github-connector --out docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/doctor-cli-readonly-runtime.jsonpurpose: Read, inspect, classify, summarize blocked reasons, and propose next lawful operation.writes_repo: diagnostic evidence onlywrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/doctor-cli-readonly-runtime.jsonnext_stage: RHPLOOP-SELF-LEARNINGforbidden:  - repair or close woundgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 10. RHPLOOP-SELF-LEARNING
```textstage: RHPLOOP-SELF-LEARNINGexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Pythonpython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - rhp/runtime_script_trace_map.pylaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Record the validated lesson that every runtime loop stage must name the exact script and Python module that executes it.writes_repo: documentation/evidence onlywrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/runtime-script-trace-map.jsonnext_stage: VALIDATIONforbidden:  - autonomous memory promotion or authority expansiongrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 11. VALIDATION
```textstage: VALIDATIONexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Python subprocesspython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - rhp/runtime_script_trace_map.py  - tests/test_rhp_020_1_runtime_script_trace_map.py  - rhp/evidence_api_compatibility_gate.pylaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - python -m py_compile rhp/runtime_script_trace_map.py tests/test_rhp_020_1_runtime_script_trace_map.py  - python -m pytest -o addopts= tests/test_rhp_020_1_runtime_script_trace_map.py  - python -m rhp.evidence_api_compatibility_gate --repo-root . --out docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/evidence-api-gate-after-runtime-script-trace-map.jsonpurpose: Compile code, run focused tests, and validate evidence API compatibility.writes_repo: validation raw outputs and evidence JSONwrites_remote: Falseraw_artifacts:  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/py-compile-runtime-script-trace-map.txt  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/focused-tests-runtime-script-trace-map.txt  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/evidence-api-gate-after-runtime-script-trace-map.jsonrepo_evidence:  - nonenext_stage: SECRET-SCANforbidden:  - commit without validation evidencegrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 12. SECRET-SCAN
```textstage: SECRET-SCANexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Python subprocesspython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - git diff --cached -U0purpose: Scan staged diff before commit.writes_repo: Falsewrites_remote: Falseraw_artifacts:  - $env:TEMP\RHP-020-1-python-streams\secret-scan-diff.txtrepo_evidence:  - nonenext_stage: COMMIT-SEALforbidden:  - commit if secret-like material is detected  - PRIVATE KEY  - github_pat_  - ghp_  - AKIA*grants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 13. COMMIT-SEAL
```textstage: COMMIT-SEALexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Python subprocesspython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - git add README.md AGENTS.md rhp/runtime_script_trace_map.py tests/test_rhp_020_1_runtime_script_trace_map.py docs/context-layer/latest-rhp.json docs/context-layer/RHP_ZERO_CONTEXT_REBUILD.md docs/context-layer/rhp_zero_context_rebuild.json docs/context-layer/operator-dashboard.txt docs/context-layer/hermes-operator-context.json docs/context-layer/ops/RHP-020-1-final-evidence.json docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map  - git commit -m "rhp: add exact runtime script trace map"purpose: Seal bounded evidence and code/doc changes locally.writes_repo: git commit onlywrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - nonenext_stage: PUSH-SEALforbidden:  - commit unbounded residuegrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 14. PUSH-SEAL
```textstage: PUSH-SEALexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Python subprocesspython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - git pull --rebase origin main  - git push origin mainpurpose: Publish sealed commit to remote.writes_repo: Falsewrites_remote: Trueraw_artifacts:  - nonerepo_evidence:  - nonenext_stage: RHPDROPforbidden:  - claim remote CI green for current operation commitgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 15. RHPDROP
```textstage: RHPDROPexecuting_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: Pythonpython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - rhp/runtime_loop.pylaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Summarize command records and raw artifact index.writes_repo: runtime-aware-command-summary.json before commit if part of evidence; temp only after sealwrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - docs/context-layer/ops/RHP-020-1-exact-runtime-script-trace-map/runtime-aware-command-summary.jsonnext_stage: RHPREFLECTforbidden:  - hide raw command artifactsgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 16. RHPREFLECT
```textstage: RHPREFLECTexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1
$env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyexecuting_language: PowerShell panel + Python evidence writerpython_script: $env:TEMP\RHP-020-1-python-streams\rhp_020_1_exact_runtime_script_trace_map.pyrepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Summarize what happened, what it means, what remains blocked, and next legal operation.writes_repo: final evidence and operator dashboard before commit; terminal panel after pushwrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - docs/context-layer/ops/RHP-020-1-final-evidence.json  - docs/context-layer/operator-dashboard.txtnext_stage: POST-SEAL-RESIDUEforbidden:  - claim wound closure or repair basisgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 17. POST-SEAL-RESIDUE
```textstage: POST-SEAL-RESIDUEexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1executing_language: PowerShellpython_script: nonerepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - git status --shortpurpose: Verify working tree is clean after commit and push.writes_repo: Falsewrites_remote: Falseraw_artifacts:  - $env:TEMP\RHP-020-1-python-streams\post-seal-residue.txtrepo_evidence:  - nonenext_stage: RETURN-ROOTforbidden:  - continue if repo residue existsgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 18. RETURN-ROOT
```textstage: RETURN-ROOTexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1executing_language: PowerShellpython_script: nonerepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: anyworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Restore operator to repo root.writes_repo: Falsewrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - nonenext_stage: HUMAN-UI-SUMMARYforbidden:  - leave operator in Downloads/temp/helper pathgrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
### 19. HUMAN-UI-SUMMARY
```textstage: HUMAN-UI-SUMMARYexecuting_script: $env:USERPROFILE\Downloads\RHP_020_1_V3_EXACT_RUNTIME_SCRIPT_TRACE_MAP_SINGLE_ALL_ONE.ps1executing_language: PowerShellpython_script: nonerepo_modules:  - nonelaunch_location: $env:USERPROFILE\Downloadsworking_directory_before: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evoworking_directory_after: C:/Users/jacks/OneDrive/Desktop/hermes-agent-evocommands:  - nonepurpose: Final operator-readable result.writes_repo: Falsewrites_remote: Falseraw_artifacts:  - nonerepo_evidence:  - nonenext_stage: noneforbidden:  - imply current operation CI is greengrants_authority: Falsecloses_wound: Falserepairs_code: Falseclaims_current_operation_ci_green: False```
