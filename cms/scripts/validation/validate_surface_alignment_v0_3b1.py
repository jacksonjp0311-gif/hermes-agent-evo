...
CURRENT_VERSION = "v0.3b1"
CURRENT_CHECKPOINT = "CMS-SA v0.3b1"
PREVIOUS_VERSION = "v0.3b"
...
ROOT_REQUIRED_TOKENS = [
    ...
    "scripts/validation/validate_surface_alignment_v0_3b1.py",
    "CMS-RCC-N-v0.3b1 / 180 days",
    "Pre-API Transmission Constraint Box",
    "API is not active in v0.3b1",
...
MINI_README_EXPECTED = {
    "configs/feedback/README.md": ["CMS-RCC-N-v0.3b1", "feedback lifecycle contract"],
    "src/cms/feedback/README.md": ["CMS-RCC-N-v0.3b1", "Feedback Lifecycle Runtime"],
    "scripts/feedback/README.md": ["CMS-RCC-N-v0.3b1", "Feedback Emitters"],
    "outputs/feedback/README.md": ["CMS-RCC-N-v0.3b1", "Feedback Outputs"],
    "reports/feedback/README.md": ["CMS-RCC-N-v0.3b1", "Feedback Reports"],
    "schemas/README.md": ["CMS-RCC-N-v0.3b1", "CMS Schemas"],
}
...
def main() -> int:
    ...
    report = {
        "schema": "CMS-SA-v0.3b1-surface-alignment-validation",
    ...
    md = [
        "# CMS-SA v0.3b1 Surface Alignment Validation",
        "",
        "| Field | Value |",
        "|---|---|",
